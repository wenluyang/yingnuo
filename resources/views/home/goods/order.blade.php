...
@section('content')
    ...
    <div class="order_box">
        ...
        <ul class="address_list">
           ...
           @foreach( $address_list as $_idx => $_address_info  )
            ...
            @endforeach
            @else
                <li style="padding: 5px 5px;"> <a href="333">快去添加收货地址啦~~</a></li>
            @endif
        </ul>
        ...
        <ul class="order_list">
            ...
            <li data="<?=$_item["id"];?>" data-quantity="<?=$_item['quantity'];?>">
                <a href="{{route('goods.show',['goods'=>$_item['id']])}}">
                    <i class="pic">
...
@section('js')
    <script src="/js/product/order.js?ver=20170317170401"></script></body>
@stop